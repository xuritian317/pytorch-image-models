...
from utils.common import file_write_log
...
def setup(args):
    ...
    model = VisionTransformer(config, args.img_size, num_classes=num_classes,smoothing_value=args.smoothing_value)
...
def main():
    ...
    parser.add_argument("--dataset", choices=["CUB_200_2011", "car", "dog", "nabirds", "INat2017", "butterfly200"],
                        ...
                        help="Which dataset.")
    parser.add_argument('--data_root', type=str, default='/hy-nas')
    ...
    parser.add_argument("--pretrained_dir", type=str, default="cct_14_7x2_384_imagenet.pth",
    ...
    parser.add_argument("--train_log_name", default="log_train_local.txt", type=str,
                        help="train_log_name")
    ...
    parser.add_argument("--momentum", default=0.9, type=float,
                        help="Weight momentum if we apply some.")
